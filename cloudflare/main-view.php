<?php
  ...
  $context  = stream_context_create($options);
    ...
    $responseDomainEBDESKCOM = file_get_contents("https://api.cloudflare.com/client/v4/zones/7a7238508b9b007696ce538ad0b55a39/dns_records?type=A", false, $context);

    $dataDomainEBDESKCOM = json_decode($responseDomainEBDESKCOM);
      
    $totalDomainEBDESKCOM = count($dataDomainEBDESKCOM->result);
    ...
    for($EBDESKCOMNumber = 0; $EBDESKCOMNumber < $totalDomainEBDESKCOM; $EBDESKCOMNumber++){
  
      $EBDESKCOMStartList = ["ima.ebdesk.com", "isa.ebdesk.com"];
      $EBDESKCOMStartListCount = count($EBDESKCOMStartList);
  
      for($EBDESKCOMStartNumber = 0; $EBDESKCOMStartNumber < $EBDESKCOMStartListCount; $EBDESKCOMStartNumber++){
  
          if($dataDomainEBDESKCOM->result[$EBDESKCOMNumber]->name == $EBDESKCOMStartList[$EBDESKCOMStartNumber]){
  
              array_push($EBDESKCOMDomainList, $dataDomainEBDESKCOM->result[$EBDESKCOMNumber]);
    ...
    // print_r($dataDomainEBDESKCOM);
        ...
        //Astra get domain list (blackeye.id)
        $responseDomainBLACKEYEID = file_get_contents("https://api.cloudflare.com/client/v4/zones/218c158e6bb0d78f22b80e51d5731417/dns_records?type=A", false, $context);

        $dataDomainBLACKEYEID = json_decode($responseDomainBLACKEYEID);
          
        $totalDomainBLACKEYEID = count($dataDomainBLACKEYEID->result);
      
        //print_r($totalDomainAll);
      
        //Blank array for astra
        $BLACKEYEIDDomainList = [];
      
        //Astra looping get astra domain list
        for($BLACKEYEIDNumber = 0; $BLACKEYEIDNumber < $totalDomainBLACKEYEID; $BLACKEYEIDNumber++){
      
          $BLACKEYEIDStartList = ["ima.blackeye.id", "isa.blackeye.id"];
          $BLACKEYEIDStartListCount = count($BLACKEYEIDStartList);
      
          for($BLACKEYEIDStartNumber = 0; $BLACKEYEIDStartNumber < $BLACKEYEIDStartListCount; $BLACKEYEIDStartNumber++){
      
              if($dataDomainBLACKEYEID->result[$BLACKEYEIDNumber]->name == $BLACKEYEIDStartList[$BLACKEYEIDStartNumber]){
      
                  array_push($BLACKEYEIDDomainList, $dataDomainBLACKEYEID->result[$BLACKEYEIDNumber]);
        ...
        //Astra get domain list (blackeye.id)
        $responseDomainCENTURIONID = file_get_contents("https://api.cloudflare.com/client/v4/zones/81c071f10e9af5aeed71e4efeb47e9ca/dns_records?type=A", false, $context);

        $dataDomainCENTURIONID = json_decode($responseDomainCENTURIONID);
          
        $totalDomainCENTURIONID = count($dataDomainCENTURIONID->result);
      
        //print_r($totalDomainAll);
      
        //Blank array for astra
        $CENTURIONIDDomainList = [];
      
        //Astra looping get astra domain list
        for($CENTURIONIDNumber = 0; $CENTURIONIDNumber < $totalDomainCENTURIONID; $CENTURIONIDNumber++){
      
          $CENTURIONIDStartList = ["ima.centurion.id", "isa.centurion.id"];
          $CENTURIONIDStartListCount = count($CENTURIONIDStartList);
      
          for($CENTURIONIDStartNumber = 0; $CENTURIONIDStartNumber < $CENTURIONIDStartListCount; $CENTURIONIDStartNumber++){
      
              if($dataDomainCENTURIONID->result[$CENTURIONIDNumber]->name == $CENTURIONIDStartList[$CENTURIONIDStartNumber]){
      
                  array_push($CENTURIONIDDomainList, $dataDomainCENTURIONID->result[$CENTURIONIDNumber]);
        ...
        <div class="row p-0 m-0">
            ...
            <div class="col-12">
                ...
                <div class="flex-shrink-0 p-3 bg-white border" style="width: 280px;">
                    ...
                    <!-- EBDESKCOM DOMAIN SECTION -->
                       
                    <?php

                        for($EBDESKCOMCardNumber = 0; $EBDESKCOMCardNumber < $EBDESKCOMStartListCount; $EBDESKCOMCardNumber++){
                            ...
                            ?>
                                ...
                                // if($BLACKEYEIDCardNumber != 0 || $BLACKEYEIDCardNumber != 1){
                                //     echo "pt-3";
                                // }
                                ...
                                ">
                                    <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title"><?=$EBDESKCOMDomainList[$EBDESKCOMCardNumber]->name?></h5>
                                        <p class="card-text">Status : 
                                        <?php
                                                                                            
                                            if($EBDESKCOMDomainList[$EBDESKCOMCardNumber]->content == "103.75.25.116"){
                                                echo "Moratel NDC Secondary - 103.75.25.116";
                                            }
                                                        
                                            if($EBDESKCOMDomainList[$EBDESKCOMCardNumber]->content == "103.75.25.118"){
                                                echo "Moratel NDC Primary - 103.75.25.118";
                                            }
                                                        
                                            if($EBDESKCOMDomainList[$EBDESKCOMCardNumber]->content == "103.121.213.206"){
                                                echo "HSP Bintaro - 103.121.213.206";
                                            }
                                                        
                                            if($EBDESKCOMDomainList[$EBDESKCOMCardNumber]->content == "103.154.125.186"){
                                                echo "Moratel Bintaro - 103.154.125.186";
                                            }
                                                        
                                            if($EBDESKCOMDomainList[$EBDESKCOMCardNumber]->content == "103.154.125.187"){
                                                echo "Moratel Bintaro - 103.154.125.187";
                                            }

                                        ?>
                                        </p>
                                        <a>Content : <?=$EBDESKCOMDomainList[$EBDESKCOMCardNumber]->content?></a>
                                        <br>
                                        <br>
                                        <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalEBDESKCOM<?=$EBDESKCOMCardNumber?>">Settings</a>
                                    </div>
                                    </div>
                                </div>
                        ...
                        <!-- BLACKEYEID DOMAIN SECTION -->

                        <?php

                            for($BLACKEYEIDCardNumber = 0; $BLACKEYEIDCardNumber < $BLACKEYEIDStartListCount; $BLACKEYEIDCardNumber++){
                                ...
                                ?>
                                    ...
                                    ">
                                        <div class="card">
                                        <div class="card-body">
                                            <h5 class="card-title"><?=$BLACKEYEIDDomainList[$BLACKEYEIDCardNumber]->name?></h5>
                                            <p class="card-text">Status : 
                                            <?php
                                                                                                
                                                if($BLACKEYEIDDomainList[$BLACKEYEIDCardNumber]->content == "103.75.25.116"){
                                                    echo "Moratel NDC Secondary - 103.75.25.116";
                                                }
                                                            
                                                if($BLACKEYEIDDomainList[$BLACKEYEIDCardNumber]->content == "103.75.25.118"){
                                                    echo "Moratel NDC Primary - 103.75.25.118";
                                                }
                                                            
                                                if($BLACKEYEIDDomainList[$BLACKEYEIDCardNumber]->content == "103.121.213.206"){
                                                    echo "HSP Bintaro - 103.121.213.206";
                                                }
                                                            
                                                if($BLACKEYEIDDomainList[$BLACKEYEIDCardNumber]->content == "103.154.125.186"){
                                                    echo "Moratel Bintaro - 103.154.125.186";
                                                }
                                                            
                                                if($BLACKEYEIDDomainList[$BLACKEYEIDCardNumber]->content == "103.154.125.187"){
                                                    echo "Moratel Bintaro - 103.154.125.187";
                                                }

                                            ?>
                                            </p>
                                            <a>Content : <?=$BLACKEYEIDDomainList[$BLACKEYEIDCardNumber]->content?></a>
                                            <br>
                                            <br>
                                            <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalBLACKEYEID<?=$BLACKEYEIDCardNumber?>">Settings</a>
                                        </div>
                                        </div>
                                    </div>
                            ...
                            <!-- CENTURIONID DOMAIN SECTION -->

                        <?php

                            for($CENTURIONIDCardNumber = 0; $CENTURIONIDCardNumber < $CENTURIONIDStartListCount; $CENTURIONIDCardNumber++){
                                ...
                                ?>
                                    ...
                                    ">
                                        <div class="card">
                                        <div class="card-body">
                                            <h5 class="card-title"><?=$CENTURIONIDDomainList[$CENTURIONIDCardNumber]->name?></h5>
                                            <p class="card-text">Status : 
                                            <?php
                                                                                                
                                                if($CENTURIONIDDomainList[$CENTURIONIDCardNumber]->content == "103.75.25.116"){
                                                    echo "Moratel NDC Secondary - 103.75.25.116";
                                                }
                                                            
                                                if($CENTURIONIDDomainList[$CENTURIONIDCardNumber]->content == "103.75.25.118"){
                                                    echo "Moratel NDC Primary - 103.75.25.118";
                                                }
                                                            
                                                if($CENTURIONIDDomainList[$CENTURIONIDCardNumber]->content == "103.121.213.206"){
                                                    echo "HSP Bintaro - 103.121.213.206";
                                                }
                                                            
                                                if($CENTURIONIDDomainList[$CENTURIONIDCardNumber]->content == "103.154.125.186"){
                                                    echo "Moratel Bintaro - 103.154.125.186";
                                                }
                                                            
                                                if($CENTURIONIDDomainList[$CENTURIONIDCardNumber]->content == "103.154.125.187"){
                                                    echo "Moratel Bintaro - 103.154.125.187";
                                                }

                                            ?>
                                            </p>
                                            <a>Content : <?=$CENTURIONIDDomainList[$CENTURIONIDCardNumber]->content?></a>
                                            <br>
                                            <br>
                                            <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalCENTURIONID<?=$CENTURIONIDCardNumber?>">Settings</a>
                                        </div>
                                        </div>
                                    </div>
                    ...
                    <?php
                        ...
                        for($EBDESKCOMCardNumber = 0; $EBDESKCOMCardNumber < $EBDESKCOMStartListCount; $EBDESKCOMCardNumber++){
                            ...
                            ?>
                                ...
                                <div class="modal fade" id="exampleModalEBDESKCOM<?=$EBDESKCOMCardNumber?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel"><?=$EBDESKCOMDomainList[$EBDESKCOMCardNumber]->name?></h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        
                                        <form action="form/update-record-view.php" method="POST">

                                            <label for="">Record Name</label>
                                            <input class="form-control" type="text" name="domain" value="<?=$EBDESKCOMDomainList[$EBDESKCOMCardNumber]->name?>" readonly="readonly">

                                            <!-- <br> -->

                                            <!-- <label for="">Record ID</label> -->
                                            <input class="form-control" type="hidden" name="recordID" value="<?=$EBDESKCOMDomainList[$EBDESKCOMCardNumber]->id?>" readonly="readonly">

                                            <br>

                                            <label for="">Content</label>
                                            <input type="hidden" name="zoneID" value="<?=$EBDESKCOMDomainList[$EBDESKCOMCardNumber]->zone_id?>">

                                            <select class="form-select" name="content" id="">
                                                <option value="103.75.25.116"
                                                ...
                                                >Moratel NDC Secondary - 103.75.25.116</option>
                                                <option value="103.75.25.118"
                                                ...
                                                >Moratel NDC Primary - 103.75.25.118</option>
                                                <option value="103.121.213.206"
                                                ...
                                                >HSP Bintaro - 103.121.213.206</option>
                                                <option value="103.154.125.186"
                                                ...
                                                >Moratel Bintaro - 103.154.125.186</option>
                                            </select>
                    ...
                    for($BLACKEYEIDCardNumber = 0; $BLACKEYEIDCardNumber < $BLACKEYEIDStartListCount; $BLACKEYEIDCardNumber++){
                        ...
                        ?>
                            ...
                            <div class="modal fade" id="exampleModalBLACKEYEID<?=$BLACKEYEIDCardNumber?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel"><?=$BLACKEYEIDDomainList[$BLACKEYEIDCardNumber]->name?></h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    ...
                                    <form action="form/update-record-view.php" method="POST">
                                        ...
                                        <label for="">Record Name</label>
                                        <input class="form-control" type="text" name="domain" value="<?=$BLACKEYEIDDomainList[$BLACKEYEIDCardNumber]->name?>" readonly="readonly">

                                        <!-- <br> -->

                                        <!-- <label for="">Record ID</label> -->
                                        <input class="form-control" type="hidden" name="recordID" value="<?=$BLACKEYEIDDomainList[$BLACKEYEIDCardNumber]->id?>" readonly="readonly">

                                        <br>

                                        <label for="">Content</label>
                                        <input type="hidden" name="zoneID" value="<?=$BLACKEYEIDDomainList[$BLACKEYEIDCardNumber]->zone_id?>">
                    ...
                    for($CENTURIONIDCardNumber = 0; $CENTURIONIDCardNumber < $CENTURIONIDStartListCount; $CENTURIONIDCardNumber++){
                        ...
                        ?>
                            ...
                            <div class="modal fade" id="exampleModalCENTURIONID<?=$CENTURIONIDCardNumber?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel"><?=$CENTURIONIDDomainList[$CENTURIONIDCardNumber]->name?></h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    ...
                                    <form action="form/update-record-view.php" method="POST">
                                        ...
                                        <label for="">Record Name</label>
                                        <input class="form-control" type="text" name="domain" value="<?=$CENTURIONIDDomainList[$CENTURIONIDCardNumber]->name?>" readonly="readonly">

                                        <!-- <br> -->

                                        <!-- <label for="">Record ID</label> -->
                                        <input class="form-control" type="hidden" name="recordID" value="<?=$CENTURIONIDDomainList[$CENTURIONIDCardNumber]->id?>" readonly="readonly">

                                        <br>

                                        <label for="">Content</label>
                                        <input type="hidden" name="zoneID" value="<?=$CENTURIONIDDomainList[$CENTURIONIDCardNumber]->zone_id?>">
