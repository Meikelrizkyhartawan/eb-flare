        ...
        <div class="row p-0 m-0">
            ...
            <div class="col-12">
                ...
                <div class="flex-shrink-0 p-3 bg-white border" style="width: 280px;">
                    ...
                    <span class="fs-5 fw-semibold">Features</span> -->
                    ...
                    ?>
                    >
                        <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed" data-bs-toggle="collapse" data-bs-target="#features-collapse" aria-expanded="true">
                    ...
                    <h1 class="text-center">Logs Activity</h1>
                            ...
                            <div class="bg-white">
                                ...
                                <table class="cell-border" id="example">
                                    ...
                                    <?php
                                        ...
                                        $mysqliGetLogsActivity = mysqli_query($connect, "SELECT * FROM logs_activity ORDER BY timestamp DESC");

                                        $numberOfRecord = 0;

                                        while($logsActivity = mysqli_fetch_assoc($mysqliGetLogsActivity)){
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$logsActivity['username']?></td>
                                            <td><?=$logsActivity['action']?></td>
                                            <td><?=$logsActivity['action_value']?></td>
                                            <td><?=$logsActivity['timestamp']?></td>
                                        </tr>
